...
class Kubernetes(BaseAPI):
    ...
    Args:
        ...
        node_storage_profile (object): Объект :class:`bcc.StorageProfile`
        ...
        floating (object): Объект класса :class:`bcc.Port`.
    ...
    class Meta:
        ...
        node_storage_profile = Field('bcc.StorageProfile')
        nodes_count = Field()
        template = Field('bcc.KubernetesTemplate')
    ...
    def get_object(cls, id, token=None):
        ...
        Returns:
            ...
            kubernetes :class:`bcc.Kubernetes`
        """
