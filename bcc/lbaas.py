...
from bcc.lbaas_pool import LbaasPool
...
class Lbaas(BaseAPI):
    ...
    Args:
        ...
        floating (object): Объект класса :class:`bcc.Port`. Порт подключения
                           ...
                           сети.
        ports (object): объект класса :class:`bcc.Port`. Сеть,
    ...
    def get_object(cls, id, token=None):
        ...
        Returns:
            object: Возвращает объект Lbaas :class:`bcc.Lbaas`
        """
    ...
    def get_lbaas_pool(self):
        ...
        Returns:
            list: Список объектов :class:`bcc.LbassPool`
        """
        if self.id is None:
            raise ObjectHasNoId
