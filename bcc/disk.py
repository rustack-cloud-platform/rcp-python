...
class Disk(BaseAPI):
    ...
    Args:
        ...
        vm (object): Объект виртуального сервера :class:`bcc.Vm`
        storage_profile (object): Объект :class:`bcc.StorageProfile`
    ...
    class Meta:
        ...
        scsi = Field()
        vdc = Field('bcc.Vdc')
        vm = Field('bcc.Vm', allow_none=True)
        storage_profile = Field('bcc.StorageProfile')
