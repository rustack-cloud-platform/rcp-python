...
class Vm(BaseAPI):
    ...
    Args:
        ...
        template (object): Объект класса :class:`bcc.Template`. Шаблон
                           операционной системы
        metadata (list): Список объектов класса :class:`bcc.VmMetadata`.
                         Список полей, необходимых для создания виртуального
                         выделенного сервера. Например, пароль или имя
                         пользователя.
        ports (list): Список объектов класса :class:`bcc.Port`. Список сетей,
                      к которым подключен данный виртуальный сервер
        disks (list): Список объектов класса :class:`bcc.Disk`. Список дисков,
                      подключенных к данному виртуальному серверу
        floating (object): Объект класса :class:`bcc.Port`. Порт подключения
    ...
    class Meta:
        ...
        power = Field()
        vdc = Field('bcc.Vdc')
        template = Field('bcc.Template')
        metadata = FieldList('bcc.VmMetadata')
        ports = FieldList('bcc.Port')
        disks = FieldList('bcc.Disk')
        floating = Field('bcc.Port', allow_none=True)
        hotadd_feature = Field()
        cdrom = Field('bcc.Image', allow_none=True)
    ...
    def get_object(cls, id, token=None):
        ...
        Returns:
            object: Возвращает объект виртуального сервера :class:`bcc.Vm`
        """
    ...
    def add_disk(self, disk):
        ...
        Args:
            disk (object): Объект диска :class:`bcc.Disk`
        """
        if disk.id:
    ...
    def add_port(self, port):
        ...
        Args:
            port (object): Новый объект :class:`bcc.Port`
        """
    ...
    def remove_port(self, port):
        ...
        Args:
            port (object): Существующий объект :class:`bcc.Port`
        """
    ...
    def revert(self, snapshot):
        ...
        Args:
            snapshot (object): объект снапшота :class:`bcc.Snapshot`
        """
    ...
    def mount_iso(self, image):
        ...
        Args:
            image (object): объект образа :class:`bcc.Image`
        """
