...
class LbaasPool(BaseAPI):
    ...
    Args:
        ...
        lbaas (object): Объект класса :class:`bcc.Lbaas`. Балансировщик, к
                          которому относится данный Lbaas Pool
        connlimit (str): лимит соединений  для пула балансировщика
        cookie_name (str): Имя cookie
        members (list): Список объектов класса :class:`bcc.LbaasPoolMember`.
    ...
    def get_object(cls, lbaas, pool_id, token=None):
        ...
        Returns:
            object: Возвращает объект LbaasPool :class:`bcc.LbaasPool`
        """
