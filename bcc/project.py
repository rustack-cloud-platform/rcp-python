...
from bcc.dns import Dns
from bcc.kubernetes import Kubernetes
from bcc.s3 import S3
...
class Project(BaseAPI):
    ...
    Args:
        ...
        name (str): Имя
        client (object): Объект класса :class:`bcc.Client`. Клиент, к которому
                         относится проект
    ...
    def get_object(cls, id, token=None):
        ...
        Returns:
            object: Возвращает объект проекта :class:`bcc.Project`
        """
    ...
    def get_available_hypervisors(self):
        ...
        объектов :class:`bcc.Hypervisor`.

        Returns:
            list: Список объектов :class:`bcc.Hypervisor`
        """
    ...
    def get_dns_zones(self):
        ...
        объектов :class:`bcc.Dns`.

        Returns:
            list: Список объектов :class:`bcc.Dns`
        """
        if self.id is None:
            raise ObjectHasNoId
    ...
    def get_k8s_clusters(self):
        ...
        Вернет список объектов :class:`bcc.Kubernetes`.

        Returns:
            list: Список объектов :class:`bcc.Kubernetes`
        """
        if self.id is None:
            raise ObjectHasNoId
    ...
    def get_s3_storages(self):
        ...
        объектов :class:`bcc.S3`.

        Returns:
            list: Список объектов :class:`bcc.S3`
        """
        if self.id is None:
            raise ObjectHasNoId
    ...
    def get_paas_templates(self):
        ...
        объектов :class:`bcc.PaasTemplate`.

        Returns:
            list: Список объектов :class:`bcc.PaasTemplate`
        """
        if self.id is None:
            raise ObjectHasNoId
        return self._get_list('v1/paas_template', 'bcc.PaasTemplate',
                              project_id=self.id)
