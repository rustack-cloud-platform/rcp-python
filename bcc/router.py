...
class Router(BaseAPI):
    ...
    Args:
        ...
        name (str): Имя
        vdc (object): ВЦОД, к которому относится маршрутизатор :class:`bcc.Vdc`
        is_default (bool): True для маршрутизатора по умолчанию
        floating (object): Порт подключения к внешней сети :class:`bcc.Port`
    ...
    def get_object(cls, id, token=None):
        ...
        Returns:
            object: Возвращает объект маршрутизатора :class:`bcc.Router`
        """
    ...
    def add_port(self, port):
        ...
        self.ports.append(resolve('bcc.Port')(token=self.token, **port))
