...
class Image(BaseAPI):
    ...
    Args:
        id (str): Идентификатор
        name (str): Имя
        files (list): Список объектов класса :class:`bcc.File`. Список файлов в
        образе
    ...
    def get_object(cls, id, token=None):
        ...
        Returns:
            object: Возвращает объект образа :class:`bcc.Image`
        """
    ...
    def deploy_vm_from_image(self, vm):
        ...
        Args:
            vm (object) - объект создаваемого сервера :class:`bcc.Vm`

        Returns:
            object: объект созданного из образа сервера  :class:`bcc.Vm`
        """
