...
class Disk(BaseAPI):
    ...
    Args:
        ...
        vm (object): Объект виртуального сервера :class:`rcp.Vm`
        storage_profile (object): Объект :class:`rcp.StorageProfile`
    ...
    class Meta:
        ...
        scsi = Field()
        vdc = Field('rcp.Vdc')
        vm = Field('rcp.Vm', allow_none=True)
        storage_profile = Field('rcp.StorageProfile')
