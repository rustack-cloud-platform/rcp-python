...
class Kubernetes(BaseAPI):
    ...
    Args:
        ...
        node_storage_profile (object): Объект :class:`rcp.StorageProfile`
        ...
        floating (object): Объект класса :class:`rcp.Port`.
    ...
    class Meta:
        ...
        node_storage_profile = Field('rcp.StorageProfile')
        nodes_count = Field()
        template = Field('rcp.KubernetesTemplate')
    ...
    def get_object(cls, id):
        ...
        Returns:
            ...
            kubernetes :class:`rcp.Kubernetes`
        """
        k8s = cls(id=id)
