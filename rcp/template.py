from rcp.base import BaseAPI, Field
...
class Template(BaseAPI):
    ...
    def get_object(cls, id):
        ...
        Returns:
            object: Возвращает объект шаблона :class:`rcp.Template`
        """
        template = cls(id=id)
    ...
    def get_fields(self):
        ...
        Returns:
            list: Список объектов :class:`rcp.TemplateField`
        """
        return self._get_list('v1/template/{}/field'.format(self.id),
                              'rcp.TemplateField', False)
